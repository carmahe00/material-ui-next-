...
const About = ({ setSelectedIndex, setValue }) => {
    ...
    return (
        <Grid container direction="column">
            <Head>
                <title key="title" >About us History and Team | Jhon Development</title>
                <meta name="description" key="description" content="We provided the fastest, most modern, afforable, 
                    and aesthetic software design and development services in the Midwest. Get free estimate now!" />
                <meta property="og:title" content="Bringing west coast Technology to the Midwest | About Us" key="og:title" />
                <meta property="og:url" content="Bringing west coast Technology to the Midwest | Free Estimate" key="og:title" />
                <meta property="org:url" key="org:url" content="jad.com/about" />
                    ...
                    <Hidden lgUp>
                        <Grid item lg style={{ maxWidth: "45em", padding: "1.25em" }}>
                            <Typography variant="body1" align="center" paragraph>
                                I taught myself basic coding from a library book in university,
                                and ever since then my passion has solely been set on learning —
                                learning about computers and learning mathematics,
