...
const Revolution = () => {
    ...
    return (
        <Grid container direction="column" >
            <Head>
                <title key="title" >The Revolution - Cutting-Edge Software | Jhon Development</title>
                <meta name="description" key="description" content="Visionary insight, coupled with cutting-edge, is a recipe for revolution. Get a free online estimeta" />
                <meta property="og:title" content="Bringing west coast Technology to the Midwest | Revolution" key="og:title" />

                <meta property="org:url" key="org:url" content="jad.com/revolution" />

                <link rel="canonical" key="canonical" href="jad.com/revolution" />
            </Head>
                ...
                <Grid item container direction="column" lg style={{ maxWidth: "40em" }} >
                    ...
                    <Grid item>
                        <Typography align={matchesMD ? "center" : "right"} variant="body1" paragraph>
                            ...
                            "/assets/buildIcon.svg"ng it, and we want to help guide the world into this next
                ...
                <Grid item container direction="column" lg style={{ maxWidth: "40em" }} >
                    ...
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                            In 2013, Facebook invented a new way o"/assets/buildIcon.svg"ng websites. This
                    ...
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                            ...
                            you can leverage the knowledge you already possessed f"/assets/buildIcon.svg"ng
            ...
            <Grid item container justifyContent="center" direction="row" className={classes.rowContainer} >
                <Grid item>
            ...
            >
                <Grid item container alignItems={matchesMD ? "center" : undefined} direction="column" lg>
                    <Grid item>
                        <Typography
                            variant="h4"
                            gutterBottom
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src="/assets/consultationIcon.svg" alt="handshake" width="70%" style={{ maxWidth: 700 }} />
                </Grid>
            </Grid>
            <Grid
                item
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src="/assets/reviewIcon.svg" alt="basic website design" width="70%" style={{ maxWidth: "40em" }} />
                </Grid>
            </Grid>
            <Grid
                item
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src="/assets/reviewIcon.svg" alt="magnifying glass" width="70%" style={{ maxWidth: "40em" }} />
                </Grid>
            </Grid>
            <Grid
                item
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src="/assets/designIcon.svg" alt="paintbrush leaving stroke of paint" style={{ maxWidth: 1000 }} width="70%" />
                </Grid>
            </Grid>
            <Grid
                item
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src="/assets/buildIcon.svg" alt="building construction site" width="70%" style={{ maxWidth: matchesMD ? 700 : 1000 }} />
                </Grid>
            </Grid>
            <Grid
                item
            ...
            <Grid
                ...
                className={classes.rowContainer}
                justifyContent={matchesMD ? "center" : undefined}
                style={{ backgroundColor: "#8E45CE", height: "150em" }}
            >
                <Grid item container alignItems={matchesMD ? "center" : undefined} direction="column" lg>
                    <Grid item>
                        <Typography align={matchesMD ? "center" : undefined} variant="h4" gutterBottom style={{ color: "#000", marginTop: "5em" }}>
            ...
            >
                ...
                <Grid item lg style={{ alignSelf: "center" }}>
                    <img src="/assets/iterateIcon.svg" alt="falling dominoes" width="70%" />
                </Grid>
            </Grid>
